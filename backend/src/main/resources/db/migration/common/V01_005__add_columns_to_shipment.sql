...
alter table shipment add constraint FK4iqnob9nyy36e497kqfovf7po foreign key (receiver_id) references customer (uuid);
alter table shipment add constraint FK6fjq37nx2gsc584yc0eaecwwf foreign key (sender_id) references customer (uuid);